...
void Initialize(ULL startAddr) {
	...
	typeIndex.insert(pair<string, string>("0110011", "R-TYPE"));
	typeIndex.insert(pair<string, string>("0010011", "I-TYPE"));
	typeIndex.insert(pair<string, string>("0100011", "S-TYPE"));
	typeIndex.insert(pair<string, string>("0000011", "I-TYPE"));
	typeIndex.insert(pair<string, string>("1100011", "SB-TYPE"));
	typeIndex.insert(pair<string, string>("1100111", "I-TYPE"));
	typeIndex.insert(pair<string, string>("1101111", "UJ-TYPE"));
	typeIndex.insert(pair<string, string>("0010111", "U-TYPE"));
	typeIndex.insert(pair<string, string>("0110111", "U-TYPE"));
	typeIndex.insert(pair<string, string>("0111011", "R-TYPE"));
	typeIndex.insert(pair<string, string>("0011011", "I-TYPE"));
	typeIndex.insert(pair<string, string>("1110011", "SYS-TYPE"));
}
